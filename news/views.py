...
from .models import NewsModel, CategoryModel, Cultural, National_url, TechScience, WorldNews
...
class HomePage(View):
    def get(self, request):
        ...
        world = WorldNews.objects.all()
        national = National_url.objects.all()
        form = SearchForm()
...
class National_urls(View):
    def get(self, request):
        national_news = National_urls.objects.all()
